    ...
    public function run()
    {
        ...
        \DB::table('decks')->insert(array (
            ...
            array (
                ...
                'scope_id' => 4,
                'type' => 3,
                'desc' => '{"en":"Cards in this control deck describe the Hero\'s current location. Each of these cards is scope for Hero\'s decks with type unique, which indicate the specific current Places of these types:\\r\\n- Biome\\r\\n- Area\\r\\n- Folk\\r\\n- Scene\\r\\n\\r\\nThe current Places of these four types change during the game. They play an important role in determining the Events that can happen to the Hero.\\r\\n\\r\\nAll Heroes inherit this deck unless they have another Place deck in their scopes hierarchy. This means that the game algorithm will automatically check for cards of the Hero scope for the presence of decks of these four types and collect them into a single deck of the Place type."}',
                'is_public' => true,
                'image' => NULL,
                'owner_id' => 1,
                'created_at' => '2022-11-24 23:47:11',
                'updated_at' => '2022-11-25 02:01:13',
            ),
            35 => 
            array (
                'id' => 48,
            ...
            array (
                ...
                'scope_id' => 79,
                'type' => 3,
                'desc' => '{"en":"This deck contains all the possible Skills that a Character can have. Each card in this Skill deck can be a scope for a specific Character deck with specializations for that Skill The algorithm will automatically check if the Character has decks for each of these Skills and assemble them into a single Skill deck."}',
                'is_public' => true,
                'image' => NULL,
                'owner_id' => 1,
                'created_at' => '2022-11-25 02:12:31',
                'updated_at' => '2022-11-25 02:16:14',
            ),
            38 => 
            array (
                'id' => 52,
            ...
            array (
                ...
                'updated_at' => '2022-11-25 03:19:58',
            ),
        ));
